...
class navigator:
    ...
    def root(self):
        ...
        self.addDirectoryItem(32000, 'collectionsNavigator', 'collectionmovies.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32910, 'movieMales', 'most-popular-actors.png', 'DefaultMovies.png')
        self.addDirectoryItem(32911, 'movieFemales', 'most-popular-actresses.png', 'DefaultMovies.png')
...
#            self.addDirectoryItem(32034, 'movies&url=imdbwatchlist', 'imdb.png', 'DefaultMovies.png', queue=True)
    ...
    def collections(self, lite=False):
        self.addDirectoryItem('[B][COLOR white]Actor[/COLOR][COLOR red] Collection[/B][/COLOR][/B]', 'collectionActors', 'collectionactors.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR white]Boxset[/COLOR][COLOR red] Collection[/B][/COLOR][/B]', 'collectionBoxset', 'collectionboxset.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR white]Christmas[/COLOR][COLOR red] Collection[/B][/COLOR][/B]', 'collections&url=xmasmovies', 'collectionxmas.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR white]Kids[/COLOR][COLOR red] Collections[/B][/COLOR][/B]', 'collectionKids', 'collectionkids.png', 'DefaultMovies.png')
...
#            self.addDirectoryItem(32041, 'episodeUserlists', 'userlists.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32120, 'clearCacheSearch', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32121, 'libtoolNavigator', 'tools.png', 'DefaultAddonProgram.png')

        self.endDirectory()


    def library(self):
        self.addDirectoryItem(32131, 'openSettings&query=6.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32132, 'updateLibrary&query=tool', 'library_update.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32133, control.setting('movie_library'), 'movies.png', 'DefaultMovies.png', isAction=False)
        self.addDirectoryItem(32134, control.setting('tv_library'), 'tvshows.png', 'DefaultTVShows.png', isAction=False)
