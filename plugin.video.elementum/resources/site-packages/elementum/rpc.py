...
class ElementumRPCServer(BaseHandler):
    ...
    def Window_Is_Loading(self):
        return xbmc.getCondVisibility('Window.IsVisible(10138)') or xbmc.getCondVisibility('Window.IsActive(10138)') or xbmc.getCondVisibility('Window.IsVisible(10160)') or xbmc.getCondVisibility('Window.IsActive(10160)')
